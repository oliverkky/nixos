return function(ctx)
    ...
    bind(main_mod .. " + R", hl.dsp.exec_cmd(ctx.menu))
    bind(main_mod .. " + X", hl.dsp.exec_cmd(config_root .. "/rofi/scripts/control-center"))
    bind(main_mod .. " + N", hl.dsp.exec_cmd(config_root .. "/rofi/scripts/control-network"))
    bind(main_mod .. " + SHIFT + B", hl.dsp.exec_cmd(config_root .. "/rofi/scripts/control-bluetooth"))
    bind(main_mod .. " + A", hl.dsp.exec_cmd(config_root .. "/rofi/scripts/control-audio"))
